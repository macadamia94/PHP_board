...
<body>
    ...
    <div class="check">
        <?php if (!$result) { ?>
            <div class="check_nm"><span style="color: blue"><b style="color: red;"><?= $uid ?></b></span> 는 사용 가능한 아이디 입니다.</div>
            <div><input type="button" class="check_btn" value="이 ID 사용" onclick="opener.location.href ='javascript: decide()';  window.close();"></div>
        <?php } else { ?>
            <div class="check_nm"><span style="color: red"><b style="color: red;"><?= $uid ?></b></span> 는 중복된 아이디 입니다.</div>
